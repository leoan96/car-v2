...
export class InitializeCarEntities1648394158342 implements MigrationInterface {
  name = 'InitializeCarEntities1648394158342';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "car_features" ("id" SERIAL NOT NULL, "feature" character varying(30) NOT NULL, CONSTRAINT "PK_3170f28e047ca7806f4be877c45" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
